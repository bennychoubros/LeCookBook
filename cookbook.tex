...
\include{recettes/Aligot}
\include{recettes/Boeuf_Bourguignon}
\include{recettes/Bœuf_and_Guinness_stew}
\include{recettes/Boudin_aux_pommes}
\include{recettes/Chipirons_à_la_Basquaise}
\include{recettes/Crème_brûlée}
\include{recettes/Crème_brûlée_au_foie_gras}
\include{recettes/Colcannon}
...
\include{recettes/Pisco_sour}
\include{recettes/Poêlée_de_chou_aux_châtaignes}
\include{recettes/Pot-au-feu}
\include{recettes/Saint-Jacques_fondue_de_poireaux}
\include{recettes/Salade_de_lentilles}
\include{recettes/Soupe_au_Panais_et_Celeri}
\include{recettes/Souris_d_agneau_confite_au_miel}
\include{recettes/Tourte_aux_Pommes_de_Terre}
\include{recettes/Truffade}
\end{document} 
